...
-(void)loadView{
    ...
    //リロード処理の初期設定（画面引っ張った時の処理設定）
    //PullRefreshTableViewController *pullRefreshTableViewController =
    //                                    [[PullRefreshTableViewController alloc]init];
    
    //[PullRefreshTableViewController setupStrings];
